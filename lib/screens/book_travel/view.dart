    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () async {
              dateTimeRange = await showDateRangePicker(context: context, firstDate: DateTime.now(), lastDate: DateTime.now().add(Duration(days: 365)));
              setState(() {});
            },
            child: TextFormField(
              ...
              enabled: false,
              decoration: InputDecoration(
                  labelText: dateTimeRange != null ? "From ${dateTimeRange!.start.toString().split(" ").first} ------> To ${dateTimeRange!.end.toString().split(" ").first}" : "Travelling Date",
                  prefixIcon: Icon(
          ...
          ElevatedButton(onPressed: () {
            navigateTo(context,page: PaymentMethods());
